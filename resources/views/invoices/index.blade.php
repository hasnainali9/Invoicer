                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex action-button">
                                    <a href="{{route('invoices.view.single',['id'=>base64_encode($Invoice->id)])}}"  class="btn btn-primary btn-xs light mr-3 px-2 edit-trigger">
                                       <i class="fa fa-eye"></i>
                                    </a>
                                    <a href="{{route('invoices.update.show',['id'=>base64_encode($Invoice->id)])}}"  class="btn btn-info btn-xs light px-2 edit-trigger">
